...
function woo_add_to_cart_ajax( $fragments ) {
	...
	?>
	<a class="cart-notification notification-link fa fa-shopping-cart <?php echo $mobile_classes; ?>" href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
		<?php if ( $cart_items ) { ?>
	...
	function boss_mobile_cart_icon_html() {
		...
		if ( $woocommerce ) {
            ...
            <div id="cart-nav-wrap" class="btn-wrap">
                <a id="cart-nav" class="cart-notification fa fa-shopping-cart sidebar-btn table-cell" href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
                    <?php if ( $cart_items ) { ?>
                        <span><?php echo $cart_items; ?></span>
                    <?php } ?>
                </a>
